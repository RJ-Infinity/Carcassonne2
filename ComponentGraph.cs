...
namespace Carcassonne2
{
    public class ComponentGraph
    {
        ...
        public ComponentGraph(ComponentsType ct)
        {
            Type = ct;
        }
        ...
        public HashSet<ComponentGraph> Borders = new();
        public static ComponentGraph Merge(ComponentGraph g1, ComponentGraph g2)
        {
            ...
            g3.Borders.UnionWith(g1.Borders);
            g3.Borders.UnionWith(g2.Borders);
            return g3;
        }
    }
}
